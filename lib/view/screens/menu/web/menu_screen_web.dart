  ...
  Widget build(BuildContext context) {
    ...
    final List<MenuModel> _menuList = [
      ...
      if(_splashProvider.configModel.referEarnStatus)
        MenuModel(icon: Images.referral_icon, title: getTranslated('refer_and_earn', context), route: Routes.getReferAndEarnRoute()),
      ...
      if(_splashProvider.configModel.loyaltyPointStatus)
        MenuModel(icon: Images.loyalty_icon, title: getTranslated('loyalty_point', context), route: Routes.getWalletRoute(false)),
