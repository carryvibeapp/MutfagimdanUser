  ...
  static Future<void> loadData(bool reload) async {
    ...
    if(Provider.of<AuthProvider>(Get.context, listen: false).isLoggedIn()){
      ...
      await Provider.of<WishListProvider>(Get.context, listen: false).initWishList(
        Get.context, Provider.of<LocalizationProvider>(Get.context, listen: false).locale.languageCode,
      );
    }

    if(reload) {
      Provider.of<ProductProvider>(Get.context, listen: false).getLatestProductList(
        Get.context, false, '1', Provider.of<LocalizationProvider>(Get.context, listen: false).locale.languageCode,
      );
      ...
      Provider.of<ProductProvider>(Get.context, listen: false).seeMoreReturn();

      Provider.of<CategoryProvider>(Get.context, listen: false).getCategoryList(
        Get.context, true, Provider.of<LocalizationProvider>(Get.context, listen: false).locale.languageCode,
      );

      Provider.of<SetMenuProvider>(Get.context, listen: false).getSetMenuList(
        Get.context, reload,Provider.of<LocalizationProvider>(Get.context, listen: false).locale.languageCode,
      );
                      ...
                      children: [
                        ...
                        Flexible(child: Column(crossAxisAlignment: CrossAxisAlignment.start,  children: [
                          ...
                          GestureDetector(
                                ...
                                child: Text(
                                  locationProvider.address.length > 0
