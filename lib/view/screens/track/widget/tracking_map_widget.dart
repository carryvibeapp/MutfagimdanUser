...
class _TrackingMapWidgetState extends State<TrackingMapWidget> {
  ...
  void setMarker() async {
    try {
      ...
      await BitmapDescriptor.fromAssetImage(ImageConfiguration(size: Size(30, 50)), Images.delivery_boy_marker).then((_marker) {
        _deliveryBoyImageData = _marker;
      });

      await BitmapDescriptor.fromAssetImage(ImageConfiguration(size: Size(30, 50)), Images.destination_marker).then((_marker) {
