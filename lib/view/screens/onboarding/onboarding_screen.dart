                      ...
                      onBoardingList.selectedIndex != onBoardingList.onBoardingList.length-1 ? Align(
                        ...
                        child: TextButton(
                            ...
                            child: Text(
                              ...
                              style: Theme.of(context).textTheme.headline3.copyWith(color: Theme.of(context).textTheme.bodyLarge.color),
                            )),
                      ) : SizedBox(),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: Theme.of(context).textTheme.headline3.copyWith(fontSize: 24.0, color: Theme.of(context).textTheme.bodyLarge.color),
